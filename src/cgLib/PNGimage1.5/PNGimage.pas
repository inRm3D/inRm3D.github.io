...
var
  ...
  Output: Pointer;
  OutputSize: Integer;  tempLongint:Longint;
begin
  ...
  tempLongint:=StrToInt(fKeyword);
  CompressionMethod := pByte(tempLongint + Length(fKeyword))^;
  fText := '';
...
procedure TPngObject.LoadFromResourceID(Instance: HInst; ResID: Integer);
  var tempStr:String;
begin
  tempStr:=IntToStr(ResID);
  LoadFromResourceName(Instance, tempStr);
end;
